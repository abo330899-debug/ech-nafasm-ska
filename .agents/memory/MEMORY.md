...
- [Nafsam CF Pages deploy](nafsam-cloudflare-deploy.md) — CLOUDFLARE_PAGES_TOKEN works now; wrangler@3 from /tmp; bump sw.js VERSION before build; verify live bundle hash.
